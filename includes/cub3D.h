...
/*   Updated: 2024/10/11 17:19:27 by lmoran           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strdup_cub(t_garbage **garbo, const char *s);
char	*return_gnl_cub(t_garbage **garbo, int fd);
...
void					free_data(t_mlx *mlx, t_data *data);
